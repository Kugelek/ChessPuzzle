...
public class QueenTest {
    ...
    public void init(){
        ...
        piece = new Queen('Q',square, board);
    }
    ...
    public void testGenerateAttackedSquares(){
        ...
        Queen anotherPiece = new Queen('Q', anotherSquare, anotherBoard);
        ...
        //kilka testów dla spr reguł atakowanych pól szachowego Hetmana
...
//        //powinny byc
        ...
        Square sqr3 = new Square(2, 2);
        Square sqr4 = new Square(7, 7);
        Square sqr5 = new Square(7, 6);
        Square sqr6 = new Square(5, 7);
        Square sqr7 = new Square(5, 6);
